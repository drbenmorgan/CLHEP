...
macro( clhep_test testname )
  ...
  if( CTST_NOLIB )
    ...
    set ( package_library_list ${PROJECT_BINARY_DIR}/lib/libCLHEP_${PACKAGE}-${VERSION}.a )
  endif()
  if( ${PACKAGE}_DEPS )
     foreach ( dep ${${PACKAGE}_DEPS} )
        message( STATUS "clhep_test ${testname} will use ${dep}")
	list(APPEND package_library_list  ${PROJECT_BINARY_DIR}/lib/libCLHEP_${dep}-${VERSION}.a )
     endforeach()
  endif()
