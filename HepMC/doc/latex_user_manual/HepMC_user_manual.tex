...
%
\begin{titlepage}
{\tiny \LaTeX-ed on \today.}%%% \fbox{\mbox{\Huge\bf\color{red}Draft!}}
...
%%%% table of contents doesn't work when compiled at CERN!
%%%% \tableofcontents
%%%% \pagebreak
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=\textwidth,clip=]{HepMC_UML.eps}
  \end{center}
...
\begin{myitemize}{Relevant Data Members}
  ...
  \myitem{random\_states}{a container of an arbitrary number of longs
...
\end{myitemize}
\begin{myitemize}{Relevant Data Members}
  \myitem{position}{$\vec{x},ct$ in [mm] stored as CLHEP
    LorentzVector}
...
\htmladdnormallink{http://cern.ch/HepMC/examples.html}
...
%\begin{figure}
%\begin{center}
%\includegraphics[height=7in,angle=270]{filename.ps}
%% this works for eps or ps files!
%\caption{\label{labelname} Put caption here!}
%\end{center}
%\end{figure}
...
%\multicolumn{3}{|c|}{Standard DELPHI Coordinate System} \\ \hline
%data1          &       data2   &       data3   \\ \hline
%\end{tabular}
%\caption{\label{keyword3} This is a table caption.}
%\end{center}
%\end{table}
...
%  ``HERWIG: A Monte Carlo event generator for simulating hadron 
