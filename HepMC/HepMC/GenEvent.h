...
namespace HepMC {
    ...
    public:
        ...
        typedef std::forward_iterator<GenParticle*,ptrdiff_t> forwardParticleIterType;
#else
        typedef std::iterator<std::forward_iterator_tag,GenVertex*,ptrdiff_t> forwardVertexIterType;
        typedef std::iterator<std::forward_iterator_tag,GenParticle*,ptrdiff_t> forwardParticleIterType;
#endif
	...
	GenParticle* particle( int i ) const { return barcode_to_particle(i); }
	...
	class particle_const_iterator :
	    public forwardParticleIterType {
	    // Iterates over all vertices in this event
	public:
