...
//
// L. Garren
// replace std::forward_iterator with the standards compliant 
// std::iterator<std::forward_iterator_tag, ...> using typedefs
// 
//////////////////////////////////////////////////////////////////////////
...
namespace HepMC {
    ...
    public:
        ...
        typedef std::forward_iterator<GenVertex*,ptrdiff_t> forwardVertexIterType;
#else
        typedef std::iterator<std::forward_iterator_tag,GenVertex*,ptrdiff_t> forwardVertexIterType;
#endif

	GenVertex( const CLHEP::HepLorentzVector& position =CLHEP::HepLorentzVector(0,0,0,0),
		   int id = 0, 
	...
	std::vector<GenParticle*> listDescendants();
	std::vector<GenParticle*> listParents() const;
	std::vector<GenParticle*> listAncestors();
	...
	CLHEP::HepLorentzVector     m_position;      //4-vec of vertex [mm]
    ...
    inline void GenVertex::set_position( const CLHEP::HepLorentzVector& position ) {
	m_position = position;
    }
