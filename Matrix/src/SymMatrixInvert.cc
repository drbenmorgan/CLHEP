...
const double HepSymMatrix::CHOLESKY_CREEP_6x6 = .002;
...

void HepSymMatrix::invert5(int & ifail) { 
...
void HepSymMatrix::invert6(int & ifail) { 
...

void HepSymMatrix::invertHaywood5  (int & ifail) {
...

void HepSymMatrix::invertHaywood6  (int & ifail) {
...

void HepSymMatrix::invertCholesky5 (int & ifail) {
...

void HepSymMatrix::invertCholesky6 (int & ifail) {
...

void HepSymMatrix::invert4  (int & ifail) {
